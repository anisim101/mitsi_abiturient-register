...
(
    ...
    document_education_at           text not null,
    ...
    owner_passport_kogda_vidal      text not null,
    owner_passport_srok             text not null,

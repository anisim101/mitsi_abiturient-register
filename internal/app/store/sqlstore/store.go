...
func (s *Store)GetPerson(id string) (error, *model.Abiturient)  {
	var uni = model.Abiturient{}
	err := s.db.QueryRow("select * from univercity where serial_and_passport_number = $1", id).Scan(
		&uni.FirstName,
		&uni.SecondName,
		&uni.ThirdName,
		&uni.LatinFirstName,
